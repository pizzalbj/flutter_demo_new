...
class c_iconAndText extends StatelessWidget {
  @override
      ...
      children: <Widget>[
        ...
        new Expanded(
          child: new Container(
            ...
            child: new Text(
              'This is quite a long name that will be cut off',
    ...
    Widget textSection = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          titleRow,
          new Text(
            'We have a description here. It may fit on 2 lines, '
    ...
    Widget body = new Container(
      ...
      child: new Row(
        children: <Widget>[
          ...
          new Expanded(child: textSection),
          new IconButton(
            onPressed: null, // Not implemented in this code tutorial
